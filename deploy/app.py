...
app = Flask(__name__)
app.secret_key = os.environ.get('SECRET_KEY', 'sua_chave_secreta_super_segura_123456')
...
ADMIN_EMAIL = os.environ.get('ADMIN_EMAIL', 'j.f.s.r95@gmail.com')
...
def carregar_admin_user():
    ...
    try:
        if os.path.exists(ADMIN_FILE):
            ...
            password_plain = os.environ.get('ADMIN_DEFAULT_PASSWORD') or 'Samu@220107'
            admin_data = {
                'email': ADMIN_EMAIL,
